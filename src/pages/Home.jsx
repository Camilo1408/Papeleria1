...
import TestimonialsSection from "../components/TestimonialsSection"; // Importamos el componente de opiniones
...
const Home = () => {
    ...
    return (
        <div>
            ...
            {/* Aquí se añade la sección de opiniones de los usuarios */}
            <TestimonialsSection />
        </div>
    );
};
