...
const AboutUs = () => {
  return (
    <div>
        <div className="h-[85vh] flex flex-col-reverse md:flex-row items-center gap-5 md:px-32 px-5 bg-cover bg-center" style={{backgroundImage:"url(/src/assets/Images/bgabout1.jpg)"}}>
        ...
        <div className="h-[85vh] flex flex-col-reverse md:flex-row items-center gap-5 md:px-32 px-5 bg-cover bg-center" style={{backgroundImage:"url(/src/assets/Images/bgabout2.jpg)"}}>
            <div className="w-full md:w-2/4 text-center space-y-2">
                <div>
